...
public class NetworkObjectPool : NetworkBehaviour
{
    ...
    HashSet<NetworkObject> releasedObjects = new HashSet<NetworkObject>();
    ...
    void RegisterPrefabInternal(GameObject prefab, int prewarmCount)
    {
        NetworkObject CreateFunc()
        {
            ...
            var pooledInstance = obj.AddComponent<PooledInstance>();
            pooledInstance.OriginPrefab = prefab;
