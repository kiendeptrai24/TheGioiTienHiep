...
public class LinhTramState_Hero : HeroState, ISkillTrigger, IAnimationTrigger
{
    public LinhTramState_Hero(HeroController hero, IStateMachine stateMachine, string anim) : base(hero, stateMachine, anim)
    {
    }
