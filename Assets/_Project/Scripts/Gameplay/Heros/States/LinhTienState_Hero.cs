...
public class LinhTienState_Hero : HeroState, ISkillTrigger, IAnimationTrigger
{
    public LinhTienState_Hero(HeroController hero, IStateMachine stateMachine, string anim) : base(hero, stateMachine, anim)
    {
    }
