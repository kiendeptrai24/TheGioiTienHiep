...
public class ToanLucNhatKichState_Hero : HeroState, ISkillTrigger, IAnimationTrigger
{
    public ToanLucNhatKichState_Hero(HeroController hero, IStateMachine stateMachine, string anim) : base(hero, stateMachine, anim)
    {
    }
