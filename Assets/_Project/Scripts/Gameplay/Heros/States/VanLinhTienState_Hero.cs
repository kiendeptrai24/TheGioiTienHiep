...
public class VanLinhTienState_Hero : HeroState, ISkillTrigger, IAnimationTrigger
{
    public VanLinhTienState_Hero(HeroController hero, IStateMachine stateMachine, string anim) : base(hero, stateMachine, anim)
    {
    }
