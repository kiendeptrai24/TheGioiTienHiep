...
public class LienKichChiThuatState_Hero : HeroState, ISkillTrigger, IAnimationTrigger
{
    public LienKichChiThuatState_Hero(HeroController hero, IStateMachine stateMachine, string anim) : base(hero, stateMachine, anim)
    {
    }
