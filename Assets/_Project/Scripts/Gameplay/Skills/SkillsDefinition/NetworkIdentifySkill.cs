...
public class NetworkIdentifySkill : BaseSkill
{
    public NetworkIdentifySkill(SkillData data, GameObject skillEffectPrefab, string skillId, string displayName, float cooldownSeconds = 1f, Type skillAnimationClass = null)
