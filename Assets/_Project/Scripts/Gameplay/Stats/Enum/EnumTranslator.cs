...
public static class EnumTranslator
{
    ...
    {
        // CultivationStage
        { CultivationStage.LuyenKhi_1, "Luyện Khí tần 1" },
        { CultivationStage.LuyenKhi_2, "Luyện Khí tần 2" },
        { CultivationStage.LuyenKhi_3, "Luyện Khí tần 3" },
        { CultivationStage.LuyenKhi_4, "Luyện Khí tần 4" },
        { CultivationStage.LuyenKhi_5, "Luyện Khí tần 5" },
        { CultivationStage.LuyenKhi_6, "Luyện Khí tần 6" },
        { CultivationStage.LuyenKhi_7, "Luyện Khí tần 7" },
        { CultivationStage.LuyenKhi_8, "Luyện Khí tần 8" },
        { CultivationStage.LuyenKhi_9, "Luyện Khí tần 9" },
