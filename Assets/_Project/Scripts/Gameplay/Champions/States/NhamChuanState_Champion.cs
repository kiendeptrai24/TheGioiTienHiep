...
public class NhamChuanState_Champion : ChampionState, ISkillTrigger, IAnimationTrigger
{
    public NhamChuanState_Champion(ChampionController champion, IStateMachine stateMachine, string anim) : base(champion, stateMachine, anim)
    {
    }
