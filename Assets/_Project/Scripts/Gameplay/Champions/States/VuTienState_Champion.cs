...
public class VuTienState_Champion : ChampionState, ISkillTrigger, IAnimationTrigger
{
    public VuTienState_Champion(ChampionController champion, IStateMachine stateMachine, string anim) : base(champion, stateMachine, anim)
    {
    }
