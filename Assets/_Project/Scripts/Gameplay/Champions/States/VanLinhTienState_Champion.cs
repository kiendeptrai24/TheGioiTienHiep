...
public class VanLinhTienState_Champion : ChampionState, ISkillTrigger, IAnimationTrigger
{
    public VanLinhTienState_Champion(ChampionController champion, IStateMachine stateMachine, string anim) : base(champion, stateMachine, anim)
    {
    }
