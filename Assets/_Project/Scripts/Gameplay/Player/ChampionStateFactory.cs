...
public class ChampionStateFactory : IStateFactory
{
    ...
    public Dictionary<Type, IState> CreateState()
    {
        _statesDictionary = new Dictionary<Type, IState>
        {
            ...
            {typeof(AttackState_Champion), new AttackState_Champion(_Champion, _machine, "StandingAttack1")},
            {typeof(AttackRangeState_Champion), new AttackRangeState_Champion(_Champion, _machine, "StandingMagicAttack")},
