...
public class ChatContentScreenManager : ScreenManager
{
    [Header("Chat Button")]
    ...
    protected override void Awake()
    {
        ...
        m_ScreensList.Add(m_ChatPrivatePanelScreen.gameObject.name, new List<GameObject> { m_ChatPrivatePanelScreen });
